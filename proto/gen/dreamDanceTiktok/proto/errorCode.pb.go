...
const (
	...
	ErrorCode_INTERNAL_ERROR ErrorCode = 20001
)
...
type NoticeResp struct {
	...
	Tips          string                 `protobuf:"bytes,2,opt,name=Tips,proto3" json:"Tips,omitempty"`                   // 通知内容
...
func (x *NoticeResp) Reset() {
	*x = NoticeResp{}
	mi := &file_errorCode_proto_msgTypes[0]
...
func (x *NoticeResp) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *NoticeResp) GetTips() string {
	if x != nil {
		return x.Tips
	}
	return ""
...
var file_errorCode_proto_rawDesc = []byte{
	...
	,
...
var file_errorCode_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_errorCode_proto_goTypes = []any{
	(ErrorCode)(0),     // 0: game.proto.ErrorCode
	(*NoticeResp)(nil), // 1: game.proto.NoticeResp
}
...
func file_errorCode_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		MessageInfos:      file_errorCode_proto_msgTypes,
	}.Build()
